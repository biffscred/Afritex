...
import NewYork from "../../images/contact/contact-image.png";
import California from "../../images/contact/contact-image.png";
          ...
          <Container>
            <Row className="gh-1 gv-2 align-items-center justify-content-center">
              ...
              <Col lg={3} className="ms-lg-n30 ps-lg-0" data-aos="fade-left">
                <h4 className="mb-30">Montreuil</h4>
                <ul className="list-group borderless pt-10">
                  ...
                  <li className="list-group-item d-flex mt-15">
                    ...
                    <a href="mailto:contactafritex@gmail.com?subject=Test%20Address%20Email">
