 ...
 */
final class Version20231019220739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item ADD CONSTRAINT FK_52EA1F092811D9C8 FOREIGN KEY (orderref_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE user ADD adress VARCHAR(255) NOT NULL, ADD is_verified TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_item DROP FOREIGN KEY FK_52EA1F092811D9C8');
        ...
        $this->addSql('ALTER TABLE `user` DROP adress, DROP is_verified');
    }
}
